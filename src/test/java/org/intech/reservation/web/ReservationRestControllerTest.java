...
class ReservationRestControllerTest {
    ...
    void makeReservationForCustomerExists() throws Exception {
        given(reservationService.makeReservationForCustomerExists(reservationRequestDTO))
                .willReturn(reservationResponseDTO);
        ...
        verify(reservationService).makeReservationForCustomerExists(captor.capture());
    ...
    void makeReservationForNewCustomer() throws Exception {
        given(reservationService.makeReservationForNewCustomer(reservationRequestNewCustomerDTO))
                .willReturn(reservationResponseDTO);
        ...
        verify(reservationService).makeReservationForNewCustomer(captor.capture());
